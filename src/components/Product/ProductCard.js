      ...
      <Grid className="product-container" container direction={"column"} rowGap={2} width={cardWidth}>
        ...
        <Grid item>
          <Grid container justifyContent={"space-between"}>
            ...
            <Grid className="discount" item>
              <Typography variant="ManropeRegular12">50% OFF</Typography>
            </Grid>
          </Grid>
        </Grid>
        <Grid item>
          <Grid container direction={"column"}>
            ...
            <Grid item>
              <Typography variant="ManropeRegular12" color={status === "Stock Available" ? "#108934" : "inherit"}>
                {status}
              </Typography>
            </Grid>
          </Grid>
        ...
        <Grid item>
          <Typography variant="ManropeRegular12">
            AED <Typography variant="ManropeBold22">{price}</Typography>
          </Typography>
        </Grid>
      </Grid>
    </Grid>
