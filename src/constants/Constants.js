...
import {
  ...
  TopBrands,
  UsersRoles,
} from "../assets/svg/General/General";
...
export const products = [
  {
    id: 1,
    imgPath: "/storefront/images/product2.png",
  ...
  {
    id: 3,
    imgPath: "/storefront/images/product3.png",
    name: "MB Raw Whey Isolate",
    status: "Stock Available",
    price: "200",
    job: "Entrepreneur",
  ...
  {
    id: 4,
    imgPath: "/storefront/images/product1.png",
    name: "MB Raw Whey Isolate",
    status: "Stock Available",
    price: "200",
    job: "Entrepreneur",
...
export const blogs = [
  {
    id: 1,
    imgPath: "/storefront/images/blog1.png",
    title: "Diabetic Care",
    description:
  ...
  {
    id: 2,
    imgPath: "/storefront/images/blog2.png",
    title: "Diabetic Care",
    description:
      "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took...",
  },
  {
    id: 3,
    imgPath: "/storefront/images/blog3.png",
    title: "Diabetic Care",
    description:
      "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took...",
  },
